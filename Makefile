...
profiler:
	gcc -pg -O1 -march=native -Wall -c main.c  basis.c  compute.c  delta.c  grobner.c  helper.c  pol.c  reduce.c  scalar.c  char_p_0.c
...
test:
	...
	gcc -g -Wall -o tester test_scalars.o pol.o helper.o scalar.o -lgmp
